          ...
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold tracking-tight text-white">
                Koimport { Trophy, Github, Twitter, Globe } from 'lucide-react';
import { Link } from 'react-router-dom';
...
export default function Footer() {
  return (
    <footer className="border-t border-zinc-800 bg-[#09090b] pt-12 pb-8">
      ...
      </div>import { Trophy, Github, Twitter, Globe } from 'lucide-react';
import { Link } from 'react-router-dom';
...
}ra<span className="text-indigo-400">Tracker</span>
              </span>
            </Link>
            <p className="mt-4 text-sm text-zinc-500 leading-relaxed">
              Your comprehensive platform for global football statistics, live scores, and expert FPL analysis.
