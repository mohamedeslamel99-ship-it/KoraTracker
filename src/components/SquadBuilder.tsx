    ...
    <div className="flex flex-col items-center w-16 relative group mt-2">
      {player && (
        <div className="absolute -top-6 left-1/2 -translate-x-1/2 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity z-30">
          ...
          <button onClick={() => setViceCaptain(player.id)} className="w-5 h-5 bg-zinc-200 rounded-full text-black font-black text-[10px] flex items-center justify-center shadow-lg hover:scale-110" title="Vice Captain">V</button>
